  ...
  return (
    <div className="achievements">
      <div className="achievements_header">
        ...
        <Link href="https://www.linkedin.com/in/somenathpaul/" target="_blank" className="Up_Explore_More_Achievements" data-aos="fade-up">
      ...
      <div className="certificates">
        ...
        <div className="small-certificate">
          ...
          <div className="small-certificate_img2">
            ...
            <Link href="https://www.linkedin.com/in/somenathpaul/" target="_blank" className="Mid_Explore_More_Achievements">
              {/* Use a button for better accessibility */}
              <button
                style={{ padding: "10px 20px", cursor: "pointer" }}
                className="Explore_More_Achievements_btn"
      ...
      {/* responsive button */}
      <Link href="https://www.linkedin.com/in/somenathpaul/" target="_blank" className="Down_Explore_More_Achievements">
        {/* Use a button for better accessibility */}
        <button
          style={{ padding: "10px 20px", cursor: "pointer" }}
          className="Explore_More_Achievements_btn"
